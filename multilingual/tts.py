...
def speak(text):
    prompt = text  #"நீ இன்று உணவு சாப்பிட்டாயா?"
    description = "A male teacher from Tamil Nadu delivers a slightly expressive and animated speech with a moderate speed and pitch. The recording is of very high quality, with the speaker's voice sounding clear and very close up."
